...
%\cvitem{\textbf{Objective:}}{A summer internship utilizing my programming skills,
%robotics experience, strong academic background, and broad interests in theory,
%programming languages, robotics, and education.}

\section{Education}
  \href{http://coursecatalog.web.cmu.edu/schoolofcomputerscience/#curriculum-b.s.incomputerscience}
  {
    \cventry{May 2017}{Carnegie Mellon University}{Pittsburgh, PA}{QPA: 3.53}{}
...
\section{Skills}
  ...
  \cvline{Libraries:}{ROS, Django, Bootstrap, Qt}
